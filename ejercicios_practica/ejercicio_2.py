...
# División
print("El resultado de dividir",numero_1,"entre",numero_2,"es",numero_1 / numero_2)
# Multiplicación
print("El resultado de multiplicar",numero_1,"por",numero_2,"es",numero_1 * numero_2)